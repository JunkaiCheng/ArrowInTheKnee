					...
					<div class='mdl-layout__header-row'>
						...
						<div class='android-navigation-container'>
							...
							<form action='sign_in.php' method='POST' enctype='multipart/form-data'>
									...
									<input type='text' name='password' value='{$new_password}' style='display: none'>
								<input class='mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast' type='submit' value='{$new_username}'>
							</form>
							</nav>
						</div>
