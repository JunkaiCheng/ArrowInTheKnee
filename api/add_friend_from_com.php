<?php
  ...
  $email1 = $_POST['email1'];
			...
			<body>
				<div class='mdl-layout mdl-js-layout mdl-layout--fixed-header'>
						...
						<div class='mdl-layout__header-row'>
							...
							<div class='android-navigation-container'>
								...
								<form action='sign_in.php' method='POST' enctype='multipart/form-data'>
										<input type='text' name='email' value='{$email1}' style='display: none'>
					...
					<div class='container' align='center'>
						...
						<div class='mdl-typography--font-light mdl-typography--display-3-color-contrast'>You cannot add yourself!</div>
						<p></p><p></p><p></p><p></p><p></p><p></p><p></p><p></p>
						<form action='game_detail.php' method='POST' enctype='multipart/form-data'>
								<input type='text' name='email' value='{$email1}' style='display: none'>
								<input type='text' name='name' value='{$games}' style='display: none'>
							<input class='mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast' type='submit' value='Back to Detail'>
						</form>
					</div>
	...
	$query = "SELECT * FROM friend_with WHERE email1 = '{$email1}' AND email2 = '{$email2}'";
	$res = mysqli_query($conn, $query);
	if ($conn->query($query)->num_rows == 0){
		$column_list = "(email1, email2)";
		$value_list = "('{$email1}', '{$email2}')";
		$query = "INSERT INTO friend_with ".$column_list." VALUES ".$value_list;
		$res = mysqli_query($conn, $query);
		$column_list = "(email1, email2)";
		$value_list = "('{$email2}', '{$email1}')";
		$query = "INSERT INTO friend_with ".$column_list." VALUES ".$value_list;
		$res = mysqli_query($conn, $query);
		print("
		<!doctype html>
		...
		<html lang='en'>
			...
			<body>
				<div class='mdl-layout mdl-js-layout mdl-layout--fixed-header'>
					...
					<div class='container' align='center'>
						<p></p><p></p><p></p><p></p><p></p><p></p><p></p><p></p>
						<div class='mdl-typography--font-light mdl-typography--display-3-color-contrast'>That guy is already a friend of you!</div>
						<p></p><p></p><p></p><p></p><p></p><p></p><p></p><p></p>
						<form action='game_detail.php' method='POST' enctype='multipart/form-data'>
								<input type='text' name='email' value='{$email1}' style='display: none'>
								<input type='text' name='name' value='{$games}' style='display: none'>
