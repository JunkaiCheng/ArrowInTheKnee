<?php
  ...
  $email = $_POST['email'];
	...
	$query = "SELECT * FROM likes WHERE email = '{$email}' AND name = '{$name}'";
	if ($conn->query($query)->num_rows == 0){
		$column_list = "(email, name)";
		$value_list = "('{$email}', '{$name}')";
		$query = "INSERT INTO likes ".$column_list." VALUES ".$value_list;
		$res = mysqli_query($conn, $query);
				...
				<div class='mdl-layout mdl-js-layout mdl-layout--fixed-header'>
					...
					<div class='container' align='center'>
						...
						<form action='find_game.php' method='POST' enctype='multipart/form-data'>
								<input type='text' name='email' value='{$email}' style='display: none'>
							<input class='mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast' type='submit' value='Back to Game Recommend'>
						</form>
					</div>
		...
		<html lang='en'>
			...
			<body>
				<div class='mdl-layout mdl-js-layout mdl-layout--fixed-header'>
					...
					<div class='container' align='center'>
						<p></p><p></p><p></p><p></p><p></p><p></p><p></p><p></p>
						<div class='mdl-typography--font-light mdl-typography--display-3-color-contrast'>This game is already in your list!</div>
						<p></p><p></p><p></p><p></p><p></p><p></p><p></p><p></p>
						<form action='find_game.php' method='POST' enctype='multipart/form-data'>
								<input type='text' name='email' value='{$email}' style='display: none'>
							<input class='mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast' type='submit' value='Back to Game Recommend'>
