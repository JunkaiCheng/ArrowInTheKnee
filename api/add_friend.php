				...
				<div class='mdl-layout mdl-js-layout mdl-layout--fixed-header'>
					...
					<div class='container' align='center'>
						...
						<form action='find_friend.php' method='POST' enctype='multipart/form-data'>
								<input type='text' name='email' value='{$email1}' style='display: none'>
							<input class='mdl-button mdl-js-button mdl-button--raised mdl-js-ripple-effect mdl-color--accent mdl-color-text--accent-contrast' type='submit' value='Back to Friend Recommend'>
						</form>
					</div>
