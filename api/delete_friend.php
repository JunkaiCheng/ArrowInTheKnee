<?php
  ...
  $email1 = $_POST['email1'];
	...
	$query = "DELETE FROM friend_with WHERE email1 = '{$email1}' AND email2 = '{$email2}'";
	$res = mysqli_query($conn, $query);
	$query = "DELETE FROM friend_with WHERE email2 = '{$email1}' AND email1 = '{$email2}'";
	$res = mysqli_query($conn, $query);
		...
		<body>
			<div class='mdl-layout mdl-js-layout mdl-layout--fixed-header'>
				...
				<div class='container' align='center'>
					...
					<div class='mdl-typography--font-light mdl-typography--display-3-color-contrast'>See you, cowboy!</div>
					<p></p><p></p><p></p><p></p><p></p><p></p><p></p><p></p>
					<form action='sign_in.php' method='POST' enctype='multipart/form-data'>
							<input type='text' name='email' value='{$email1}' style='display: none'>
							<input type='text' name='password' value='{$password}' style='display: none'>
